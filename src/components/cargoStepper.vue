    ...
    <div class="cargo-stepper">
        <div class="cargo-stepper__container">
            ...
            <div class="cargo-stepper__bars">
                <div
                    class="cargo-stepper__bar"
                    :class="{ 'cargo-stepper__bar--active': step == 1 }"
                ></div>
                <div
                    class="cargo-stepper__bar"
                    :class="{ 'cargo-stepper__bar--active': step == 2 }"
                ></div>
                <div
                    class="cargo-stepper__bar"
                    :class="{ 'cargo-stepper__bar--active': step == 3 }"
                ></div>
            </div>
        </div>
    </div>
