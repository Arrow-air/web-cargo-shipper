<template>
    <div
        :class="[
            'input-2-icon',
            darkMode ? 'input-dark-mode' : 'input-light-mode',
        ]"
    >
    ...
    .input-2-icon {
        ...
        .input__div {
            ...
            &:focus-within {
                ...
                box-shadow: 0px 0px 0px 2px rgba(12, 9, 32, 0.25),
                    -6px 0px 19px 8px rgba(52, 60, 194, 0.25),
                    6px 6px 20px rgba(255, 178, 162, 0.25);
                border-radius: 25px;
            }
