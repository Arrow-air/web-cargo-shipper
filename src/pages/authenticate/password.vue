<template>
    <div class="arrow-grid">
        <div class="arrow-grid-child-fw authenticate__email">
            ...
            />
            <a href="" class="authenticate__forgot-password">Reset password</a>
            <ActionButton
                :id="'buttonSubmit'"
                :buttonText="'Login'"
...
<script setup>
    ...
    const paragraph = ref(
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer non massa non neque cursus interdum in eget erat."
    );
